...
So you don't need to train your own vocoder.
...
You can download the checkpoint by following the link above, or you can download it using the command line with [gdown](https://pypi.org/project/gdown/). First ensure that you have _gdown_ installed, you can install with `pip install gdown`. Then to download the checkpoint you can run:
