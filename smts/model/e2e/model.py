...
from smts.model.feature_prediction.FastSpeech2_lightning.fs2.type_definitions import (
    Stats,
)
from smts.model.feature_prediction.FastSpeech2_lightning.fs2.utils import plot_mel
from smts.model.vocoder.HiFiGAN_iSTFT_lightning.hfgl.model import HiFiGAN
from smts.utils.heavy import dynamic_range_compression_torch, expand


class SmallTeamSpeech(pl.LightningModule):
    def __init__(self, config: SMTSConfig):
        super().__init__()
        self.config = config
