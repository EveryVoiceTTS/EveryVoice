...
class SubsampleTest(TestCase):
    ...
    def test_error_validation(self):
        ...
        self.assertIn("Invalid value for '-f' / '--format':", result.stdout)
        self.assertIn("is not one of 'psv', 'tsv', 'csv', 'festival'.", result.stdout)
        ...
        self.assertNotEqual(result.exit_code, 0)
        self.assertIn(
            "Invalid value: Festival formatted files cannot have a speaker id.",
            result.stdout,
        )
