...
class TestTextSplit(TestCase):
    def test_strong_boundary(self):
        ...
        text = a + " " + b
        self.assertEqual([a, b], txtsplit(text))
    ...
    def test_custom_desired_length(self):
        ...
        text = a + " " + b + " " + c + " " + d + " " + e
        self.assertEqual([a + " " + b, c + " " + d, e], txtsplit(text, 75, 1000))
    ...
    def test_normalization(self):
        ...
        self.assertEqual([a], txtsplit(text))
    ...
    def test_quote_toggling(self):
        ...
        self.assertEqual([text], txtsplit(text, 75, 1000))

    def test_invalid_lengths(self):
        text = "Hello, world!"
        with self.assertRaises(AssertionError):
            txtsplit(text, 200, 100)
